...
import { deletePictureUsingPost, getPictureV0ByIdUsingGet } from '@/api/pictureController'
...
const doEdit = () => {
  routeNavigator.push(`/addPicture?id=` + picture.value.id)
}
// 3. 删除
